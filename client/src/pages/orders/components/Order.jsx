                    ...
                    <div className="w-full max-w-7xl px-0 md:px-5 lg-6 mx-auto">
                        ...
                        <div className="main-box border border-gray-200 rounded-xl pt-6 max-w-xl max-lg:mx-auto lg:max-w-full">
                                ...
                                <div className="data">
                                    ...
                                    <p className="font-semibold text-base leading-7 text-black mt-4">
                                        ...
                                        <span className="text-gray-400 font-medium">
                                            {" "}
                                            {/* {order.paymentStatus} */}
                                            <Pill mode={order.paymentStatus} text={order.paymentStatus} />
                                        </span>
                                    </p>
                                    <p className="font-semibold text-base leading-7 text-black mt-4">
                                        Order Status :{" "}
                                        <span className="text-gray-400 font-medium">
                                            {" "}
                                            <Pill mode={order.status} text={order.status} />
                                        </span>
                                    </p>
                                </div>
                            ...
                            <div className="w-full px-3 min-[400px]:px-6">
                                {order && order.items.length>0 && order.items.map(item =>(<OrderItem item={item}/>))}
                            ...
                            <div className="w-full border-t border-gray-200 px-6 flex flex-col lg:flex-row items-center justify-between ">
                                ...
                                <p className="font-semibold text-lg text-black py-6">
                                    Total Price {"(including discount)"}:{" "}
