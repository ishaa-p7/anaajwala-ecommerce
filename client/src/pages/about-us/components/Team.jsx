                            ...
                            <div className="rounded overflow-hidden shadow-md bg-white dark:bg-gray-900">
                                ...
                                <div className="px-6 mt-16">
                                    ...
                                    <p className="text-center text-gray-600 dark:text-gray-200 text-base pt-3 font-normal">
                                        The CEO's role in raising a company's
                                        corporate IQ is to establish an
                            ...
                            <div className="rounded overflow-hidden shadow-md bg-white dark:bg-gray-900">
                                ...
                                <div className="px-6 mt-16">
                                    ...
                                    <p className="text-center text-gray-600 dark:text-gray-200 text-base pt-3 font-normal">
                                        ...
                                        technology in our companies has resulted
                                        in a few of them establishing global
                                        benchmarks in product design and
                                        development.
                                    </p>
                                    <div className="w-full flex justify-center pt-5 pb-5">
                                        <a
                        ...
                        >
                            <div className="rounded overflow-hidden shadow-md bg-white dark:bg-gray-900">
                                ...
                                <div className="px-6 mt-16">
                                    ...
                                    <p className="text-center text-gray-600 dark:text-gray-200 text-base pt-3 font-normal">
                                        Our services encompass the assessment
                                        and repair of property damage caused by
                                        water, fire, smoke, or mold. We can also
                        ...
                        >
                            <div className="rounded overflow-hidden shadow-md bg-white dark:bg-gray-900">
                                ...
                                <div className="px-6 mt-16">
                                    ...
                                    <p className="text-center text-gray-600 dark:text-gray-200 text-base pt-3 font-normal">
                                        An avid open-source developer who loves
                                        to be creative and inventive. I have 20
                        ...
                        >
                            <div className="rounded overflow-hidden shadow-md bg-white dark:bg-gray-900">
                                ...
                                <div className="px-6 mt-16">
                                    ...
                                    <p className="text-center text-gray-600 dark:text-gray-200 text-base pt-3 font-normal">
                                        Product designer with interests in
                                        immersive computing and XR, political
                        ...
                        >
                            <div className="rounded overflow-hidden shadow-md bg-white dark:bg-gray-900">
                                ...
                                <div className="px-6 mt-16">
                                    ...
                                    <p className="text-center text-gray-600 dark:text-gray-200 text-base pt-3 font-normal">
                                        A UX designer is the voice of the
                                        customer. Our job is to look beyond the
                                        business goals. We don't just experience
